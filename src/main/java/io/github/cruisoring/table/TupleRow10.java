...
public class TupleRow10<T, U, V, W, X, Y, Z, A, B, C> extends TupleRow9<T, U, V, W, X, Y, Z, A, B>
    ...
    public TupleRow10(IMetaData indexes, WithValues10<T, U, V, W, X, Y, Z, A, B, C> values) {
    ...
    public TupleRow10(IMetaData indexes, final T t, final U u, final V v, final W w, final X x, final Y y,
