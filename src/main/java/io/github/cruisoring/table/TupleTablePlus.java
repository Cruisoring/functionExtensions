...
public class TupleTablePlus<T, U, V, W, X, Y, Z, A, B, C>
    ...
    protected TupleTablePlus(String c1, String c2, String c3, String c4, String c5,
                             String c6, String c7, String c8, String c9, String c10, String c11, String... more) {
        super(ArrayHelper.mergeTypedArray(new String[]{c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11}, more));
    }
}
