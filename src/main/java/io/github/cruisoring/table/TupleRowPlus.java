...
public class TupleRowPlus<T, U, V, W, X, Y, Z, A, B, C> extends TupleRow10<T, U, V, W, X, Y, Z, A, B, C>
    ...
    public TupleRowPlus(IMetaData indexes, WithValuesPlus<T, U, V, W, X, Y, Z, A, B, C> values) {
    ...
    public TupleRowPlus(IMetaData indexes, final T t, final U u, final V v, final W w, final X x, final Y y,
