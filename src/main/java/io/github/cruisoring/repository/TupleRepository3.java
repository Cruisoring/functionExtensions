 ...
 */
public class TupleRepository3<TKey, T, U, V>
        extends Repository<TKey, Tuple3<T, U, V>>
        implements TupleValues3<TKey, T, U, V> {
     ...
     */
    protected TupleRepository3(Map<TKey, Tuple3<T, U, V>> map,
     ...
     * @param valueFunction Function to map 1 key to Tuple of 3 elements
     */
    protected TupleRepository3(FunctionThrowable<TKey, Tuple3<T, U, V>> valueFunction) {
     ...
     */
    public static <TKey, T, U, V> TupleRepository3<TKey, T, U, V> fromKey(
     ...
     * @return Constructed Repository to map 1 key to 3 values as a Tuple
     */
    public static <K1, T, U, V> TupleKeys1<K1, T, U, V> fromKeys1(
            Map<Tuple1<K1>, Tuple3<T, U, V>> map,
    ...
    public static <K1, K2, T, U, V> TupleKeys2<K1, K2, T, U, V> fromKeys2(
            Map<Tuple2<K1, K2>, Tuple3<T, U, V>> map,
     ...
     */
    public static <K1, K2, K3, T, U, V> TupleKeys3<K1, K2, K3, T, U, V> fromKeys3(
            Map<Tuple3<K1, K2, K3>, Tuple3<T, U, V>> map,
     ...
     */
    public static <K1, K2, K3, K4, T, U, V> TupleKeys4<K1, K2, K3, K4, T, U, V> fromKeys4(
            Map<Tuple4<K1, K2, K3, K4>, Tuple3<T, U, V>> map,
     ...
     */
    public static <K1, K2, K3, K4, K5, T, U, V> TupleKeys5<K1, K2, K3, K4, K5, T, U, V> fromKeys5(
            Map<Tuple5<K1, K2, K3, K4, K5>, Tuple3<T, U, V>> map,
     ...
     */
    public static <K1, K2, K3, K4, K5, K6, T, U, V> TupleKeys6<K1, K2, K3, K4, K5, K6, T, U, V> fromKeys6(
            Map<Tuple6<K1, K2, K3, K4, K5, K6>, Tuple3<T, U, V>> map,
     ...
     */
    public static <K1, K2, K3, K4, K5, K6, K7, T, U, V> TupleKeys7<K1, K2, K3, K4, K5, K6, K7, T, U, V> fromKeys7(
            Map<Tuple7<K1, K2, K3, K4, K5, K6, K7>, Tuple3<T, U, V>> map,
     ...
     * @param <V>  type of the third element of the Tuple.Tuple3 value mapped from the key
     */
    public static class TupleKeys1<K1, T, U, V> extends TupleRepository3<Tuple1<K1>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys1.TupleValues3<K1, T, U, V> {
         ...
         * @param valueFunction   Function to map 1 key to Tuple of 3 elements
         */
        protected TupleKeys1(Map<Tuple1<K1>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple1<K1>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             FunctionThrowable<K1, Tuple3<T, U, V>> valueFunction) {
         ...
         * @param valueFunction Function to map 1 key to Tuple of 3 elements
         */
        protected TupleKeys1(FunctionThrowable<K1, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
     ...
     */
    public static class TupleKeys2<K1, K2, T, U, V> extends TupleRepository3<Tuple2<K1, K2>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys2.TupleValues3<K1, K2, T, U, V> {
         ...
         * @param valueFunction   Function to map 2 keys to Tuple of 3 elements
         */
        protected TupleKeys2(Map<Tuple2<K1, K2>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple2<K1, K2>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             BiFunctionThrowable<K1, K2, Tuple3<T, U, V>> valueFunction) {
         ...
         * @param valueFunction Function to map 2 keys to Tuple of 3 elements
         */
        protected TupleKeys2(BiFunctionThrowable<K1, K2, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
     ...
     * @param <V>  type of the third element of the Tuple.Tuple3 mapped from the key
     */
    public static class TupleKeys3<K1, K2, K3, T, U, V> extends TupleRepository3<Tuple3<K1, K2, K3>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys3.TupleValues3<K1, K2, K3, T, U, V> {
         ...
         * @param valueFunction   Function to map 3 keys to Tuple of 3 elements
         */
        protected TupleKeys3(Map<Tuple3<K1, K2, K3>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple3<K1, K2, K3>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             TriFunctionThrowable<K1, K2, K3, Tuple3<T, U, V>> valueFunction) {
         ...
         * @param valueFunction Function to map 3 keys to Tuple of 3 elements
         */
        protected TupleKeys3(TriFunctionThrowable<K1, K2, K3, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
     ...
     * @param <V>  type of the third element of the Tuple.Tuple3 mapped from the key
     */
    public static class TupleKeys4<K1, K2, K3, K4, T, U, V> extends TupleRepository3<Tuple4<K1, K2, K3, K4>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys4.TupleValues3<K1, K2, K3, K4, T, U, V> {
         ...
         * @param valueFunction   Function to map 4 keys to Tuple of 3 elements
         */
        protected TupleKeys4(Map<Tuple4<K1, K2, K3, K4>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple4<K1, K2, K3, K4>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             QuadFunctionThrowable<K1, K2, K3, K4, Tuple3<T, U, V>> valueFunction) {
         ...
         * @param valueFunction Function to map 4 keys to Tuple of 3 elements
         */
        protected TupleKeys4(QuadFunctionThrowable<K1, K2, K3, K4, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
     ...
     * @param <V>  type of the third element of the Tuple.Tuple3 mapped from the key
     */
    public static class TupleKeys5<K1, K2, K3, K4, K5, T, U, V> extends TupleRepository3<Tuple5<K1, K2, K3, K4, K5>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys5.TupleValues3<K1, K2, K3, K4, K5, T, U, V> {
         ...
         * @param valueFunction   Function to map 5 keys to Tuple of 3 elements
         */
        protected TupleKeys5(Map<Tuple5<K1, K2, K3, K4, K5>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple5<K1, K2, K3, K4, K5>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             PentaFunctionThrowable<K1, K2, K3, K4, K5, Tuple3<T, U, V>> valueFunction) {
            super(map, changesConsumer, tuple ->
         ...
         * @param valueFunction Function to map 5 keys to Tuple of 3 elements
         */
        protected TupleKeys5(PentaFunctionThrowable<K1, K2, K3, K4, K5, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
     ...
     * @param <V>  type of the third element of the Tuple.Tuple3 mapped from the key
     */
    public static class TupleKeys6<K1, K2, K3, K4, K5, K6, T, U, V> extends TupleRepository3<Tuple6<K1, K2, K3, K4, K5, K6>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys6.TupleValues3<K1, K2, K3, K4, K5, K6, T, U, V> {
         ...
         * @param valueFunction   Function to map 6 keys to Tuple of 3 elements
         */
        protected TupleKeys6(Map<Tuple6<K1, K2, K3, K4, K5, K6>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple6<K1, K2, K3, K4, K5, K6>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             HexaFunctionThrowable<K1, K2, K3, K4, K5, K6, Tuple3<T, U, V>> valueFunction) {
            super(map, changesConsumer, tuple ->
                    valueFunction.apply(tuple.getFirst(), tuple.getSecond(), tuple.getThird(),
         ...
         * @param valueFunction Function to map 6 keys to Tuple of 3 elements
         */
        protected TupleKeys6(HexaFunctionThrowable<K1, K2, K3, K4, K5, K6, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
     ...
     * @param <V>  type of the third element of the Tuple.Tuple3 mapped from the key
     */
    public static class TupleKeys7<K1, K2, K3, K4, K5, K6, K7, T, U, V> extends TupleRepository3<Tuple7<K1, K2, K3, K4, K5, K6, K7>, T, U, V>
            implements io.github.cruisoring.repository.TupleKeys7.TupleValues3<K1, K2, K3, K4, K5, K6, K7, T, U, V> {
         ...
         * @param valueFunction   Function to map 7 keys to Tuple of 3 elements
         */
        protected TupleKeys7(Map<Tuple7<K1, K2, K3, K4, K5, K6, K7>, Tuple3<T, U, V>> map,
                             TriConsumerThrowable<Tuple7<K1, K2, K3, K4, K5, K6, K7>, Tuple3<T, U, V>, Tuple3<T, U, V>> changesConsumer,
                             HeptaFunctionThrowable<K1, K2, K3, K4, K5, K6, K7, Tuple3<T, U, V>> valueFunction) {
            super(map, changesConsumer, tuple ->
                    valueFunction.apply(tuple.getFirst(), tuple.getSecond(), tuple.getThird(),
         ...
         * @param valueFunction Function to map 7 keys to Tuple of 3 elements
         */
        protected TupleKeys7(HeptaFunctionThrowable<K1, K2, K3, K4, K5, K6, K7, Tuple3<T, U, V>> valueFunction) {
            this(new HashMap(), null, valueFunction);
        }
    }
}
