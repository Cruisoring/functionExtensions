 ...
 * @param <K1>  type of the first element of the Keys of the map, that are type of Tuple4
 * @param <K2>  type of the second element of the Keys of the map, that are type of Tuple4
 * @param <K3>  type of the third element of the Keys of the map, that are type of Tuple4
 * @param <K4>  type of the fourth element of the Keys of the map, that are type of Tuple4
 */
public interface TupleKeys4<K1,K2,K3,K4> extends TupleKeys<Tuple4<K1,K2,K3,K4>> {
     ...
     */
    default Tuple4<K1,K2,K3,K4> getKey(K1 k1, K2 k2, K3 k3, K4 k4){
    ...
    /**
     * Interface for map.keys that are of <tt>Tuple</tt> of 4 elements and keep the methods to use them as strong-typed
     * values to fetch mapped values of Tuple.Tuple4 composed by 1 element
     * @param <K1>  type of the first element of the Keys of the map, that are type of Tuple4
     * @param <K2>  type of the second element of the Keys of the map, that are type of Tuple4
     * @param <K3>  type of the third element of the Keys of the map, that are type of Tuple4
     * @param <K4>  type of the fourth element of the Keys of the map, that are type of Tuple4
     ...
     */
    interface TupleValues1<K1,K2,K3,K4, T> extends TupleKeys4<K1,K2,K3,K4>,
            io.github.cruisoring.repository.TupleValues1<Tuple4<K1,K2,K3,K4>, T> {
     ...
     */
    interface TupleValues2<K1,K2,K3,K4, T,U> extends TupleValues1<K1,K2,K3,K4, T>,
            io.github.cruisoring.repository.TupleValues2<Tuple4<K1,K2,K3,K4>, T,U> {
     ...
     */
    interface TupleValues3<K1,K2,K3,K4, T,U,V> extends TupleValues2<K1,K2,K3,K4, T,U>,
            io.github.cruisoring.repository.TupleValues3<Tuple4<K1,K2,K3,K4>, T,U,V> {
     ...
     */
    interface TupleValues4<K1,K2,K3,K4, T,U,V,W> extends TupleValues3<K1,K2,K3,K4, T,U,V>,
            io.github.cruisoring.repository.TupleValues4<Tuple4<K1,K2,K3,K4>, T,U,V,W> {
     ...
     */
    interface TupleValues5<K1,K2,K3,K4, T,U,V,W,X> extends TupleValues4<K1,K2,K3,K4, T,U,V,W>,
            io.github.cruisoring.repository.TupleValues5<Tuple4<K1,K2,K3,K4>, T,U,V,W,X> {
     ...
     */
    interface TupleValues6<K1,K2,K3,K4, T,U,V,W,X,Y> extends TupleValues5<K1,K2,K3,K4, T,U,V,W,X>,
            io.github.cruisoring.repository.TupleValues6<Tuple4<K1,K2,K3,K4>, T,U,V,W,X,Y> {
     ...
     * @param <Y>   type of the sixth element of the Tuple value
     */
    interface TupleValues7<K1,K2,K3,K4, T,U,V,W,X,Y,Z> extends TupleValues6<K1,K2,K3,K4, T,U,V,W,X,Y>,
            io.github.cruisoring.repository.TupleValues7<Tuple4<K1,K2,K3,K4>, T,U,V,W,X,Y,Z> {
