...
public interface ILogWithColor {
    ...
    static String[] DefaultSuccessKeywords = new String[]{"success", "passed", "pass"};
    //Default keywords to be matched with the template to see if message means failure
    static String[] DefaultFailedKeywords = new String[]{"fail", "error", "exception", "wrong", "mistake", "problem"};
