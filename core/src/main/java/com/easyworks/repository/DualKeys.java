 ...
 * @param <K2>  type of the second element of the Keys of the map, that are type of Dual
 */
public interface DualKeys<K1,K2> extends TupleKeys<Dual<K1,K2>> {
    ...
    interface SingleValues<K1,K2, T> extends DualKeys<K1,K2>,
            com.easyworks.repository.SingleValues<Dual<K1, K2>, T> {
    ...
    interface DualValues<K1,K2, T,U> extends SingleValues<K1,K2, T>,
            com.easyworks.repository.DualValues<Dual<K1, K2>, T,U> {
    ...
    interface TripleValues<K1,K2, T,U,V> extends DualValues<K1,K2, T,U>,
            com.easyworks.repository.TripleValues<Dual<K1,K2>, T,U,V> {
    ...
    interface QuadValues<K1,K2, T,U,V,W> extends TripleValues<K1,K2, T,U,V>,
            com.easyworks.repository.QuadValues<Dual<K1,K2>, T,U,V,W> {
    ...
    interface PentaValues<K1,K2, T,U,V,W,X> extends QuadValues<K1,K2, T,U,V,W>,
            com.easyworks.repository.PentaValues<Dual<K1,K2>, T,U,V,W,X> {
    ...
    interface HexaValues<K1,K2, T,U,V,W,X,Y> extends PentaValues<K1,K2, T,U,V,W,X>,
            com.easyworks.repository.HexaValues<Dual<K1,K2>, T,U,V,W,X,Y> {
    ...
    interface HeptaValues<K1,K2, T,U,V,W,X,Y,Z> extends HexaValues<K1,K2, T,U,V,W,X,Y>,
            com.easyworks.repository.HeptaValues<Dual<K1,K2>, T,U,V,W,X,Y,Z> {
