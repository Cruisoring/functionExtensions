...
import com.easyworks.repository.TupleRepository;
...
public class ArrayHelper<T,R> {
    ...
    protected static final QuadValuesRepository<Class, Class, FunctionThrowable<Integer, Object>, BiFunctionThrowable<Object, Integer, Object>, TriConsumerThrowable<Object, Integer, Object>> classArrayFactories = MultiValuesRepository.toQuadValuesRepository(
            () -> new HashMap<Class, Quad<Class, FunctionThrowable<Integer, Object>, BiFunctionThrowable<Object, Integer, Object>, TriConsumerThrowable<Object, Integer, Object>>>(){{
                put(int.class, Tuple.create(Integer.class, i -> new int[i], Array::getInt, (array, index, value) -> Array.setInt(array, index, (int)value)));
                put(char.class, Tuple.create(Character.class, i -> new char[i], Array::getChar, (array, index, value) -> Array.setChar(array, index, (char)value)));
                put(byte.class, Tuple.create(Byte.class, i -> new byte[i], Array::getByte, (array, index, value) -> Array.setByte(array, index, (byte)value)));
                put(boolean.class, Tuple.create(Boolean.class, i -> new boolean[i], Array::getBoolean, (array, index, value) -> Array.setBoolean(array, index, (boolean)value)));
                put(short.class, Tuple.create(Short.class, i -> new short[i], Array::getShort, (array, index, value) -> Array.setShort(array, index, (short)value)));
                put(long.class, Tuple.create(Long.class, i -> new long[i], Array::getLong, (array, index, value) -> Array.setLong(array, index, (long)value)));
                put(float.class, Tuple.create(Float.class, i -> new float[i], Array::getFloat, (array, index, value) -> Array.setFloat(array, index, (float)value)));
                put(double.class, Tuple.create(Double.class, i -> new double[i], Array::getDouble, (array, index, value) -> Array.setDouble(array, index, (double)value)));
                put(Object[].class, Tuple.create(Object.class, i -> new Object[i], Array::get, Array::set));
            }},
            null,
            clazz -> Tuple.create(
                    clazz,
...
//    }
    ...
    public static <T> T[] convertArray(Object fromArray, Class<T> toElementType){
        ...
        return (T[]) converter.apply(fromArray);
    }
    ...
    public static <T> T[] toArray(Collection collection, Class<T[]> arrayClass){
        ...
        try {
            ...
            return (T[])convertArray(objects, arrayClass.getComponentType());
        } catch (Exception ex){
            return null;
        }
    }
